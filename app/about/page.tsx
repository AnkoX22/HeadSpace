    ...
    return (
        <>
            ...
            <div className={styles.divClass}>
                ...
                <br/>
                <p className={styles.methodDetails}>The Pomodoro Technique is a time management method developed by Francesco Cirillo in the late
            ...
            <div className={styles.divClass}>
                ...
                <br/>
                <p className={styles.methodDetails}> Interleaving is a process where students mix, or interleave, multiple subjects or topics while they study in order to improve their learning</p>
                <br/>
            </div>
            <div className={styles.divClass}>
                <br/>
            ...
            <div className={styles.divClass}>
                ...
                <br/>
                <p className={styles.methodDetails}>The Recall and Revise study method is a highly effective learning strategy that emphasizes active engagement with material and periodic review to reinforce memory. It is rooted in the principles of active recall and spaced repetition, which are backed by cognitive science as being essential for deep learning and long-term retention.</p>
                <br/>
            </div>
            <div className={styles.divClass}>
                <br/>
