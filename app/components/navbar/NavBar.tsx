    ...
    return (
        <nav className={styles.navBar}>
            ...
            <ul className={styles.navList}>
                ...
                <li className={styles.listItem}><a href='/elaborate_interrogation' className={styles.navLink}>Elaborate
                    Interrogation</a></li>
                <li className={styles.listItem}><a href='/mind_mapping' className={styles.navLink}>Mind Mapping</a></li>
                <li className={styles.listItem}><a href='/practice_testing' className={styles.navLink}>Practice
                    Testing</a></li>
                <li className={styles.listItem}><a href='/review_revise' className={styles.navLink}>Review & Revise</a>
                </li>
            </ul>
        </nav>
    );
